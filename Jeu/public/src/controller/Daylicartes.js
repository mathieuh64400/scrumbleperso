...
export default class Daylicartes extends Controller {
  ...
  constructor() {
    ...
    let url = 'http://localhost:3050/api/dayli';
    ...
    const displayCharacters = (characters) => {
        ...
        editelement.addEventListener("click", (e) => {
          ...
          if (editButtonIsPressed) {
            ...
            submition.addEventListener('click', (e) => {
              ...
              fetch('http://localhost:3050/api/dayli/' + id, {
                method: 'PATCH',
                body: JSON.stringify({
      ...
      supp.forEach(element => {
        element.addEventListener("click", (e) => {
          ...
          fetch('http://localhost:3050/api//dayli' + element.id, {
            method: 'DELETE'
          })
